          ...
          <View style={styles.scrollContent}>
            ...
            <View style={styles.description}>
              ...
              <Text style={styles.sectionText}>
                ...
                Screen is filled with usage examples of fundamental components
                for a given application. Use this merge-friendly way for your
                team to show/use/test components. Examples are registered inside
                each component's file for quick changes and usage
                identification.
              </Text>
            </View>
